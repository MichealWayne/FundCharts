...
var wrap = function wrap(fcComp) {
  return function (_ref3) {
    var prefix = _ref3.prefix,
        options = _ref3.options,
        props = _objectWithoutProperties(_ref3, ["prefix", "options"]);

    var ref = (0, _react.useRef)();

    var _useState = (0, _react.useState)(generateId(prefix || 'fundcharts-')),
        _useState2 = _slicedToArray(_useState, 1),
        id = _useState2[0];

    var _useState3 = (0, _react.useState)(null),
        _useState4 = _slicedToArray(_useState3, 2),
        charter = _useState4[0],
        setCharter = _useState4[1];

    (0, _react.useEffect)(function () {
      if (ref.current) {
        if (!charter) {
          var _charter = null;
          _charter = new fcComp(_objectSpread({
            id: id
          }, options, {}, props));
          ...
          arr.push(props);
          charter.update(_objectSpread({}, options, {}, props));
        }
      }
    }, [ref, id, options]);
