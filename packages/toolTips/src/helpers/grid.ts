 ...
 * @fit Line/Bar
 */
export const BasicToolTip = handleToolTipOptions(function ({ xData, yDatas, xPos }) {
  const { ctx, opts } = this;
  ...
  _rectX = handleLimitedVal(_rectX, opts.chartLeft, xLimit);
 ...
 * @fit Line/Bar
 */
export const ArrowToolTip = handleToolTipOptions(function ({ xData, yDatas, xPos, index }) {
  const { ctx, opts } = this;
 ...
 * @fit Kline
 */
export const KlineToolTip = handleToolTipOptions(function ({ xData, xPos, yPos }) {
  xPos = Math.abs(xPos);
  yPos = Math.abs(yPos);
  const { ctx, opts } = this;
  ...
  // draw left and top label background
  ...
  _rectX = handleLimitedVal(_rectX, opts.chartLeft, xLimit);
  _rectY = handleLimitedVal(_rectX, opts.chartTop, yLimit);
