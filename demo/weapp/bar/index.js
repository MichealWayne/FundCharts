...
const { ArrowToolTip } = FundChartsToolTips;
...
Page({
  ...
  drawBar() {
    ...
    let bar3 = new BarChart({
      ...
      datas: [[1, 3, 2, 3, 3.2, 4, 5, -6.1, -3, -5, 3, 2, 3, 3.2, 4, 5]],
      font: {
        color: '#fff',
      },
      colors: ['#6892df'],
  ...
  chart1Touchstart: function (e) {
    if (e) {
      ...
      ArrowToolTip.call(
        bar1,
        index,
        [bar1.opts.datas[0][index]],
        bar1.opts.xaxis[index],
        event.x,
        event.y
      );
    }
  ...
  chart5Touchstart: function (e) {
    if (e) {
      ...
      ArrowToolTip.call(
        bar5,
        index,
        bar5.opts.datas.map(item => item[index]),
        bar5.opts.xaxis[index],
        event.x,
        event.y
      );
    }
